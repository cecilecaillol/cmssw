...
#  matchGmt = cms.bool(False), #FIXME change collection
...
#    )
#  ),
#  gmtSrc = cms.InputTag("l1ScGmtUnpacker", "Muon"),
#  matchGmt = cms.bool(False), #FIXME
#  drCut = cms.double(0.1),
#  phiMult = cms.double(576./(2*math.pi)),
#  etaMult = cms.double(1./0.010875),
#  debug = cms.bool(True)
...
process.scMuonTable = cms.EDProducer("ConverterMuonsToFlatTable",
...
process.stubTable = cms.EDProducer("ConverterStubsToFlatTable",
  ...
  src = cms.InputTag("kbmtfConvert", ""),
  #src = cms.InputTag("kbmtfEmulation"),
  name = cms.string("L1Stubs"),
  doc = cms.string("Converted stubs"),
  #algoSettings = bmtfKalmanTrackingSettings,
  #addStubs = cms.bool(True)
)

process.kbmtfTable = cms.EDProducer("ConverterKbmtfTracksToFlatTable",
  #src = cms.InputTag("kbmtfEmulation", "L1MuKBMTrack"),
  src = cms.InputTag("kbmtfEmulation", ""),
  #src = cms.InputTag("kbmtfEmulation"),
...
process.genTable = cms.EDProducer("ConverterGenParticlesToFlatTable",
  ...
  name = cms.string("Gen"),
  doc = cms.string("Generated particles with status 1")
)

process.hltTable = cms.EDProducer("ConverterHLTToFlatTable",
  triggerBits = cms.InputTag("TriggerResults","","HLT"),
  name = cms.string("HLT"),
  doc = cms.string("HLT decisions")
)

process.triggerObjectsTable = cms.EDProducer("ConverterTriggerObjectsToFlatTable",
  objects = cms.InputTag("selectedPatTrigger"),
  bits = cms.InputTag("TriggerResults","","HLT"),
  name = cms.string("TriggerObjects"),
  doc = cms.string("HLT decisions")
)
...
process.out = cms.OutputModule("NanoAODOutputModule",
    ...
    #outputCommands = cms.untracked.vstring("drop *", "keep *_*_kbmtf*_*"),
    #outputCommands = cms.untracked.vstring("keep *"),
    outputCommands = cms.untracked.vstring("drop *", "keep l1ScoutingRun3*_*_*_*", "keep nanoaodFlatTable_*Table_*_*"),
