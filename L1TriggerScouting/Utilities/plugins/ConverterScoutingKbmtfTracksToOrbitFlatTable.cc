...
void ConverterScoutingKbmtfTracksToOrbitFlatTable::produce(edm::Event& iEvent, const edm::EventSetup& iSetup) {
  ...
  std::vector<float> met_bxm9(out->size());
  std::vector<float> met_bxm8(out->size());
  std::vector<float> met_bxm7(out->size());
  std::vector<float> met_bxm6(out->size());
  std::vector<float> met_bxm5(out->size());
  std::vector<float> met_bxm4(out->size());
  std::vector<float> met_bxm3(out->size());
  std::vector<float> met_bxm2(out->size());
  std::vector<float> met_bxm1(out->size());
  std::vector<float> met_bx0(out->size());
  ...
  for (const L1MuKBMTrack& track : *src) {
    ...
    met_bxm6[i] =track.met_bxm6();
    met_bxm5[i] =track.met_bxm5();
    met_bxm4[i] =track.met_bxm4();
    met_bxm3[i] =track.met_bxm3();
    met_bxm2[i] =track.met_bxm2();
    met_bxm1[i] =track.met_bxm1();
    met_bx0[i] =track.met_bx0();
    bx[i] =track.bx();
  ...
  out->addColumn<float>("met_bxm9", met_bxm9, "met in bx-9");
  out->addColumn<float>("met_bxm8", met_bxm8, "met in bx-8");
  out->addColumn<float>("met_bxm7", met_bxm7, "met in bx-7");
  out->addColumn<float>("met_bxm6", met_bxm6, "met in bx-6");
  out->addColumn<float>("met_bxm5", met_bxm5, "met in bx-5");
  out->addColumn<float>("met_bxm4", met_bxm4, "met in bx-4");
  out->addColumn<float>("met_bxm3", met_bxm3, "met in bx-3");
  out->addColumn<float>("met_bxm2", met_bxm2, "met in bx-2");
  out->addColumn<float>("met_bxm1", met_bxm1, "met in bx-1");
  out->addColumn<float>("met_bx0", met_bx0, "met in bx");
